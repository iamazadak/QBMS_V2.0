...
const SidebarProvider = React.forwardRef(
  (
    ...
    // Simplified mobile detection for this specific environment without cookie logic for now
    // We'll use a simple state since we don't have the cookies lib installed
    ...
    // Close sidebar automatically on mobile when path changes (optional, can be done in Layout)
  ...
  ({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
    ...
    return (
      <div
        ...
        data-side={side}
      >
        {/* This is what keeps the gap in the layout */}
        <div
          className={cn(
