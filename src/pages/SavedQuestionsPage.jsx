...
export default function SavedQuestionsPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">Saved Questions</h1>
        <p className="text-slate-600 mt-2">Your bookmarked questions and personal notes</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{savedQuestions.length}</p>
              </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">{savedQuestions.filter(q => q.is_favorite).length}</p>
              </div>
        ...
        <Card className="bg-gradient-to-r from-green-500 to-green-600 text-white border-none">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-green-100">With Notes</p>
                <p className="text-2xl font-bold">{savedQuestions.filter(q => q.notes).length}</p>
              </div>
              <Edit2 className="w-8 h-8 text-green-200" />
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      {filteredQuestions.length === 0 ? (
        ...
        <div className="space-y-6">
          {filteredQuestions.map((savedItem) => (
